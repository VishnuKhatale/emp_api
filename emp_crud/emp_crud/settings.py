"""
Django settings for emp_crud project.
...
SECRET_KEY = 'django-insecure-bc%=ep4_0vhxg83o%&(3_v^s=0!!vaxurw95!48*llc-40bak9'
...
WSGI_APPLICATION = 'emp_crud.wsgi.application'
